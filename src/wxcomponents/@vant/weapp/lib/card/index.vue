<template>
<uni-shadow-root class="@vant-weapp-lib-card-index"><view class="custom-class van-card">
...
global['__wxRoute'] = '@vant/weapp/lib/card/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/card/index']
</script>
