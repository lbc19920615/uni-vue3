<template>
<uni-shadow-root class="@vant-weapp-lib-area-index"><van-picker class="van-area__picker" active-class="active-class" toolbar-class="toolbar-class" column-class="column-class" show-toolbar value-key="name" :title="title" :loading="loading" :columns="computed.displayColumns(columns, columnsNum)" :item-height="itemHeight" :visible-item-count="visibleItemCount" :cancel-button-text="cancelButtonText" :confirm-button-text="confirmButtonText" @change="onChange" @confirm="onConfirm" @cancel="onCancel"></van-picker></uni-shadow-root>
</template>
...
global['__wxRoute'] = '@vant/weapp/lib/area/index'
'use strict';
var __assign =
  (this && this.__assign) ||
  function () {
...
export default global['__wxComponents']['@vant/weapp/lib/area/index']
</script>
