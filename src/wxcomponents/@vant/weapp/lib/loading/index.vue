<template>
<uni-shadow-root class="@vant-weapp-lib-loading-index"><view :class="'custom-class '+(utils.bem('loading', { vertical }))">
...
global['__wxRoute'] = '@vant/weapp/lib/loading/index'
'use strict';
