<template>
<uni-shadow-root class="@vant-weapp-lib-tabs-index"><view :class="'custom-class '+(utils.bem('tabs', [type]))">
...
global['__wxRoute'] = '@vant/weapp/lib/tabs/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/tabs/index']
</script>
