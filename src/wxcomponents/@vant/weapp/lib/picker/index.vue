<template>
<uni-shadow-root class="@vant-weapp-lib-picker-index"><view class="van-picker custom-class">
...
global['__wxRoute'] = '@vant/weapp/lib/picker/index'
'use strict';
var __assign =
  (this && this.__assign) ||
  function () {
