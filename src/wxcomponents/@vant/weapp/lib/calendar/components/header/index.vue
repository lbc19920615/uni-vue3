<template>
<uni-shadow-root class="@vant-weapp-lib-calendar-components-header-index"><view class="van-calendar__header">
...
global['__wxRoute'] = '@vant/weapp/lib/calendar/components/header/index'
'use strict';
var __spreadArray =
...
export default global['__wxComponents']['@vant/weapp/lib/calendar/components/header/index']
</script>
