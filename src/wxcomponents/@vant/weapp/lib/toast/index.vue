<template>
<uni-shadow-root class="@vant-weapp-lib-toast-index"><van-overlay v-if="mask || forbidClick" :show="show" :z-index="zIndex" :custom-style="mask ? '' : 'background-color: transparent;'"></van-overlay>
...
global['__wxRoute'] = '@vant/weapp/lib/toast/index'
'use strict';
