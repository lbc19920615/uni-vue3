<template>
<uni-shadow-root class="@vant-weapp-lib-sidebar-item-index"><view :class="(utils.bem('sidebar-item', { selected, disabled }))+' '+(selected ? 'active-class' : '')+' '+(disabled ? 'disabled-class' : '')+' custom-class'" hover-class="van-sidebar-item--hover" hover-stay-time="70" @click="onClick">
...
global['__wxRoute'] = '@vant/weapp/lib/sidebar-item/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/sidebar-item/index']
</script>
