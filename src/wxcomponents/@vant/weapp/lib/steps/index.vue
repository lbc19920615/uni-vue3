<template>
<uni-shadow-root class="@vant-weapp-lib-steps-index"><view :class="'custom-class '+(utils.bem('steps', [direction]))">
...
global['__wxRoute'] = '@vant/weapp/lib/steps/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/steps/index']
</script>
