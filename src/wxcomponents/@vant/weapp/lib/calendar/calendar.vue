<template>
<uni-shadow-root class="@vant-weapp-lib-calendar-calendar"><view class="van-calendar">
...
global['__wxRoute'] = '@vant/weapp/lib/calendar/calendar'

Component({})

export default global['__wxComponents']['@vant/weapp/lib/calendar/calendar']
</script>
