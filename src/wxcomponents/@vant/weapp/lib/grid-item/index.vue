<template>
<uni-shadow-root class="@vant-weapp-lib-grid-item-index"><view :class="'custom-class '+(utils.bem('grid-item', { square }))" :style="computed.wrapperStyle({ square, gutter, columnNum, index })" @click="onClick">
...
global['__wxRoute'] = '@vant/weapp/lib/grid-item/index'
'use strict';
