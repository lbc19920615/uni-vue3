<template>
<uni-shadow-root class="@vant-weapp-lib-radio-index"><view :class="(utils.bem('radio', [direction]))+' custom-class'">
...
global['__wxRoute'] = '@vant/weapp/lib/radio/index'
'use strict';
