<template>
<uni-shadow-root class="@vant-weapp-lib-count-down-index"><view class="van-count-down">
...
global['__wxRoute'] = '@vant/weapp/lib/count-down/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/count-down/index']
</script>
