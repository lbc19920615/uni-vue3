<template>
<uni-shadow-root class="@vant-weapp-lib-index-anchor-index"><view class="van-index-anchor-wrapper" :style="wrapperStyle">
...
global['__wxRoute'] = '@vant/weapp/lib/index-anchor/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/index-anchor/index']
</script>
