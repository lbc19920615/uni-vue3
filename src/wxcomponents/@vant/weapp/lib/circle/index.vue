<template>
<uni-shadow-root class="@vant-weapp-lib-circle-index"><view class="van-circle">
...
global['__wxRoute'] = '@vant/weapp/lib/circle/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/circle/index']
</script>
<style platform="mp-weixin">
@import '../common/index.css';.van-circle{position:relative;display:inline-block;text-align:center}.van-circle__text{position:absolute;top:50%;left:0;width:100%;transform:translateY(-50%);color:#323233;color:var(--circle-text-color,#323233)}
</style>