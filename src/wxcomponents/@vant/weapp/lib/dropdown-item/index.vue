<template>
<uni-shadow-root class="@vant-weapp-lib-dropdown-item-index"><view v-if="showWrapper" :class="utils.bem('dropdown-item', direction)" :style="wrapperStyle">
...
global['__wxRoute'] = '@vant/weapp/lib/dropdown-item/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/dropdown-item/index']
</script>
