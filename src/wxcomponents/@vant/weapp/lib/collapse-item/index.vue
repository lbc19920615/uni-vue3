<template>
<uni-shadow-root class="@vant-weapp-lib-collapse-item-index"><view :class="'van-collapse-item custom-class '+(index !== 0 ? 'van-hairline--top' : '')">
...
global['__wxRoute'] = '@vant/weapp/lib/collapse-item/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/collapse-item/index']
</script>
