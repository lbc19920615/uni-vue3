<template>
<uni-shadow-root class="@vant-weapp-lib-notify-index"><van-transition name="slide-down" :show="show" custom-class="van-notify__container" :custom-style="computed.rootStyle({ zIndex, top })" @click.native="onTap">
...
global['__wxRoute'] = '@vant/weapp/lib/notify/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/notify/index']
</script>
