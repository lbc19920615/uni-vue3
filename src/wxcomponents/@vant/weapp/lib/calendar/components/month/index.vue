<template>
<uni-shadow-root class="@vant-weapp-lib-calendar-components-month-index"><view class="van-calendar__month" :style="computed.getMonthStyle(visible, date, rowHeight)">
...
global['__wxRoute'] = '@vant/weapp/lib/calendar/components/month/index'
'use strict';
