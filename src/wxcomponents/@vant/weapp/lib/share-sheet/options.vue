<template>
<uni-shadow-root class="@vant-weapp-lib-share-sheet-options"><view :class="utils.bem('share-sheet__options', { border: showBorder })">
...
global['__wxRoute'] = '@vant/weapp/lib/share-sheet/options'
'use strict';
var __assign =
  (this && this.__assign) ||
  function () {
