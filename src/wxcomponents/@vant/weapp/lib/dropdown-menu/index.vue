<template>
<uni-shadow-root class="@vant-weapp-lib-dropdown-menu-index"><view class="van-dropdown-menu van-dropdown-menu--top-bottom">
...
global['__wxRoute'] = '@vant/weapp/lib/dropdown-menu/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/dropdown-menu/index']
</script>
