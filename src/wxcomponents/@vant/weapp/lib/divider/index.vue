<template>
<uni-shadow-root class="@vant-weapp-lib-divider-index"><view :class="'custom-class '+(utils.bem('divider', [{ dashed, hairline }, contentPosition]))" :style="computed.rootStyle({ borderColor, textColor, fontSize, customStyle })">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/lib/divider/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/divider/index']
</script>
