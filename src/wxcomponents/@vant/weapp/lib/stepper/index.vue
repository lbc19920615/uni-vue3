<template>
<uni-shadow-root class="@vant-weapp-lib-stepper-index"><view :class="(utils.bem('stepper', [theme]))+' custom-class'">
...
global['__wxRoute'] = '@vant/weapp/lib/stepper/index'
'use strict';
var __assign =
  (this && this.__assign) ||
  function () {
...
export default global['__wxComponents']['@vant/weapp/lib/stepper/index']
</script>
