<template>
<uni-shadow-root class="@vant-weapp-lib-col-index"><view :class="'custom-class '+(utils.bem('col', [span]))+' '+(offset ? 'van-col--offset-' + offset : '')" :style="computed.rootStyle({ gutter })">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/lib/col/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/col/index']
</script>
