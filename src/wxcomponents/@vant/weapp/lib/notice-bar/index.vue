<template>
<uni-shadow-root class="@vant-weapp-lib-notice-bar-index"><view v-if="show" :class="'custom-class '+(utils.bem('notice-bar', { withicon: mode, wrapable }))" :style="computed.rootStyle({ color, backgroundColor, background })" @click="onClick">
...
global['__wxRoute'] = '@vant/weapp/lib/notice-bar/index'
'use strict';
