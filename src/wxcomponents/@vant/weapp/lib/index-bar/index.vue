<template>
<uni-shadow-root class="@vant-weapp-lib-index-bar-index"><view class="van-index-bar">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/lib/index-bar/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/index-bar/index']
</script>
