<template>
<uni-shadow-root class="@vant-weapp-lib-progress-index"><view class="van-progress custom-class" :style="computed.rootStyle({ strokeWidth, trackColor })">
...
global['__wxRoute'] = '@vant/weapp/lib/progress/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/progress/index']
</script>
