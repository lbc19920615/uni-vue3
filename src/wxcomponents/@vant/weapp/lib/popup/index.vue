<template>
<uni-shadow-root class="@vant-weapp-lib-popup-index"><van-overlay v-if="overlay" :show="show" :z-index="zIndex" :custom-style="overlayStyle" :duration="duration" @click="onClickOverlay" :lock-scroll="lockScroll"></van-overlay>
...
global['__wxRoute'] = '@vant/weapp/lib/popup/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/popup/index']
</script>
