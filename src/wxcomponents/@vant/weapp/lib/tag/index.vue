<template>
<uni-shadow-root class="@vant-weapp-lib-tag-index"><view :class="'custom-class '+(utils.bem('tag', [type, size, { mark, plain, round }]))" :style="computed.rootStyle({ plain, color, textColor })">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/lib/tag/index'
'use strict';
