<template>
<uni-shadow-root class="@vant-weapp-lib-skeleton-index"><view v-if="loading" :class="'custom-class '+(utils.bem('skeleton', [{animate}]))">
...
global['__wxRoute'] = '@vant/weapp/lib/skeleton/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/skeleton/index']
</script>
