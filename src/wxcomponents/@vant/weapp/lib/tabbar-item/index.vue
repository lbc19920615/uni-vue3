<template>
<uni-shadow-root class="@vant-weapp-lib-tabbar-item-index"><view :class="(utils.bem('tabbar-item', { active }))+' custom-class'" :style="'color: '+(active ? activeColor : inactiveColor)" @click="onClick">
...
global['__wxRoute'] = '@vant/weapp/lib/tabbar-item/index'
'use strict';
