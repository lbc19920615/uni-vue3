<template>
<uni-shadow-root class="@vant-weapp-lib-overlay-index"><van-transition v-if="lockScroll" :show="show" custom-class="van-overlay" :custom-style="'z-index: '+(zIndex)+'; '+(customStyle)" :duration="duration" @click.native="onClick" @touchmove.native.stop.prevent="noop">
  <slot></slot>
</van-transition>
...
global['__wxRoute'] = '@vant/weapp/lib/overlay/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/overlay/index']
</script>
