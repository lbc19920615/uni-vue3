<template>
<uni-shadow-root class="@vant-weapp-lib-nav-bar-index"><view v-if="fixed && placeholder" :style="'height: '+(height)+'px;'"></view>
...
global['__wxRoute'] = '@vant/weapp/lib/nav-bar/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/nav-bar/index']
</script>
