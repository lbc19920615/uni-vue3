<template>
<uni-shadow-root class="@vant-weapp-lib-info-index"><view v-if="info !== null && info !== '' || dot" :class="'van-info '+(utils.bem('info', { dot }))+' custom-class'" :style="customStyle">{{ dot ? '' : info }}</view></uni-shadow-root>
</template>
<wxs src="../wxs/utils.wxs" module="utils"></wxs>
<script>

global['__wxRoute'] = '@vant/weapp/lib/info/index'
'use strict';
