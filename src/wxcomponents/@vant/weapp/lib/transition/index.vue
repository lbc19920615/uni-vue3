<template>
<uni-shadow-root class="@vant-weapp-lib-transition-index"><view v-if="inited" :class="'van-transition custom-class '+(classes)" :style="computed.rootStyle({ currentDuration, display, customStyle })" @transitionend="onTransitionEnd">
  <slot></slot>
...
global['__wxRoute'] = '@vant/weapp/lib/transition/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/transition/index']
</script>
