<template>
<uni-shadow-root class="@vant-weapp-lib-search-index"><view :class="(utils.bem('search', { withaction: showAction || useActionSlot }))+' custom-class'" :style="'background: '+(background)">
...
global['__wxRoute'] = '@vant/weapp/lib/search/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/search/index']
</script>
