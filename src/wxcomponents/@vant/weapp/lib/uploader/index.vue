<template>
<uni-shadow-root class="@vant-weapp-lib-uploader-index"><view class="van-uploader">
...
global['__wxRoute'] = '@vant/weapp/lib/uploader/index'
'use strict';
var __assign =
  (this && this.__assign) ||
  function () {
...
export default global['__wxComponents']['@vant/weapp/lib/uploader/index']
</script>
