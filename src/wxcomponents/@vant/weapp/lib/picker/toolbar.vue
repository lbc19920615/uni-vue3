<template>
<uni-shadow-root class="@vant-weapp-lib-picker-toolbar"><view v-if="showToolbar" class="van-picker__toolbar toolbar-class">
...
global['__wxRoute'] = '@vant/weapp/lib/picker/toolbar'

Component({})

export default global['__wxComponents']['@vant/weapp/lib/picker/toolbar']
</script>
