<template>
<uni-shadow-root class="@vant-weapp-lib-switch-index"><view :class="(utils.bem('switch', { on: checked === activeValue, disabled }))+' custom-class'" :style="computed.rootStyle({ size, checked, activeColor, inactiveColor })" @click="onClick">
...
global['__wxRoute'] = '@vant/weapp/lib/switch/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/switch/index']
</script>
