<template>
<uni-shadow-root class="@vant-weapp-lib-empty-index"><view class="custom-class van-empty">
...
global['__wxRoute'] = '@vant/weapp/lib/empty/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/empty/index']
</script>
