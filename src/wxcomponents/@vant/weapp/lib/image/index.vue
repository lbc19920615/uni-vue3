<template>
<uni-shadow-root class="@vant-weapp-lib-image-index"><view :style="computed.rootStyle({ width, height, radius })" :class="'custom-class '+(utils.bem('image', { round }))" @click="onClick">
...
global['__wxRoute'] = '@vant/weapp/lib/image/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/image/index']
</script>
