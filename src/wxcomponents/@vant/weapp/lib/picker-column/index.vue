<template>
<uni-shadow-root class="@vant-weapp-lib-picker-column-index"><view class="van-picker-column custom-class" :style="computed.rootStyle({ itemHeight, visibleItemCount })" @touchstart="onTouchStart" @touchmove.stop.prevent="onTouchMove" @touchend="onTouchEnd" @touchcancel="onTouchEnd">
...
global['__wxRoute'] = '@vant/weapp/lib/picker-column/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/picker-column/index']
</script>
