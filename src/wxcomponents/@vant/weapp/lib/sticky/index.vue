<template>
<uni-shadow-root class="@vant-weapp-lib-sticky-index"><view class="custom-class van-sticky" :style="computed.containerStyle({ fixed, height, zIndex })">
...
global['__wxRoute'] = '@vant/weapp/lib/sticky/index'
'use strict';
...
export default global['__wxComponents']['@vant/weapp/lib/sticky/index']
</script>
