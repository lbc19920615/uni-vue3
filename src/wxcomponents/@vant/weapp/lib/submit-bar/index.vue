<template>
<uni-shadow-root class="@vant-weapp-lib-submit-bar-index"><view class="van-submit-bar custom-class">
  <slot name="top"></slot>
...
global['__wxRoute'] = '@vant/weapp/lib/submit-bar/index'
'use strict';
